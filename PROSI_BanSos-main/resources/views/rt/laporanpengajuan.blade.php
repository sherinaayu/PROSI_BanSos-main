        ...
        <table class="data-table">
            ...
            <tbody>
              <tr>
                ...
                <td>Disetujui</td>
                <td>11-04-2024</td>
                <td><a href="{{ url('/laporanpengajuan/detail/1') }}" class="btn-detail"><i class="fas fa-info-circle"></i> Detail</a>
              ...
              <tr>
                ...
                <td>Ditolak</td>
                <td>12-09-2024</td>
                <td><a href="{{ url('/laporanpengajuan/detail/2') }}" class="btn-detail"><i class="fas fa-info-circle"></i> Detail</a>
              ...
              <tr>
                ...
                <td>Disetujui</td>
                <td>26-05-2024</td>
                <td><a href="{{ url('/laporanpengajuan/detail/3') }}" class="btn-detail"><i class="fas fa-info-circle"></i> Detail</a>
